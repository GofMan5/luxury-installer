...
- press one build action to save and revalidate current edits, build a real `.exe`, `.deb` + `.rpm`, or `.dmg` for the selected native target, then reveal it directly from Studio.
