...
5. `Studio`: typed unsigned-v1 settings, Rust-owned create/open/import/replace/entrypoint/icon/save dialogs, active-folder reveal, project reload/validation, and build; renderer never supplies native paths.
